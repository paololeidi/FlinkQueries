...
public class QueryCompositionJson {
    ...
    public static final String OUTPUT_FILE_NAME = "Files/Output/Networks/Json/flink-flink-flink.json";
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<OutputEvent> outputEventStream = outputStream.map(str -> {
            ...
            // Extract specific fields
            String windowOpenStr = jsonObject.getString("windowOpen");
            String windowCloseStr = jsonObject.getString("windowClose");
            int id = jsonObject.getInt("id");
            int maxStress = jsonObject.getInt("maxStress");

            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
            LocalDateTime windowOpenLDT = LocalDateTime.parse(windowOpenStr, formatter);
            ZonedDateTime windowOpenZDT = windowOpenLDT.atZone(ZoneId.of("Europe/Paris"));
            Instant windowOpen = windowOpenZDT.toInstant();
            LocalDateTime windowCloseLDT = LocalDateTime.parse(windowCloseStr, formatter);
    ...
    private static String formatString(String line) {
        ...
        String jsonString = csvToJson(joiner.toString());
        return jsonString;
    }

    private static String csvToJson(String csvString) {
